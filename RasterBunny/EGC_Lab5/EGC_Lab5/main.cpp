...
void drawRasterizedTrinagle(SDL_Renderer *renderer, egc::vec4 vertex1, egc::vec4 vertex2, egc::vec4 vertex3) {
...
void renderMesh(SDL_Renderer *renderer, std::vector<tinyobj::shape_t> shapes)
{
    ...
    for (size_t i = 0; i < shapes.size(); i++) {
        ...
        for (size_t f = 0; f < shapes[i].mesh.indices.size() / 3; f++) {
            ...
            drawRasterizedTrinagle(renderer, tempVertex1, tempVertex2, tempVertex3);
